# Misty Rainforest Waybar - Installation & Usage Guide
...
```bash
ln -sf ~/path/to/misty-rainforest/waybar-config.jsonc ~/.config/waybar/config.jsonc
ln -sf ~/path/to/misty-rainforest/waybar-style.css ~/.config/waybar/style.css
```
...
```css
@define-color accent #7a9e7e; /* Change primary accent */
@define-color blue #6ba89f; /* Change turquoise accent */
@define-color green #5a8e7a; /* Change jade green accent */
```
