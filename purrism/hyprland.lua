...
hl.config({
	general = {
		...
		gaps_out = 10,
		border_size = 1,
		col = { active_border = "rgba(ffffff80) rgba(ffffff18) 135deg", inactive_border = "rgba(ffffff14)" },
	...
	group = {
		col = {
			border_active = "rgba(ffffff80) rgba(ffffff18) 135deg",
			border_inactive = "rgba(ffffff14)",
